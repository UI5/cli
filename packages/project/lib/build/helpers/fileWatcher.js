 ...
 * This is meant for CI and other environments where sources do not change while the server runs, so
 * the watching overhead (especially the polling backend's tree walk on container volumes) adds cost
 * without benefit.
 *
 * @private
