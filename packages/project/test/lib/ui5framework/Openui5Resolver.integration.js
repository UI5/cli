...
test.serial("resolveVersion", async (t) => {
	...
	for (const options of optionsArguments) {
		...
		// Ranges
		t.is(await Openui5Resolver.resolveVersion("1", options.ui5DataDir, options), "1.120.1");
		t.is(await Openui5Resolver.resolveVersion("1.120", options.ui5DataDir, options), "1.120.1");
		t.is(await Openui5Resolver.resolveVersion("1.x", options.ui5DataDir, options), "1.120.1");
		t.is(await Openui5Resolver.resolveVersion("1.x.x", options.ui5DataDir, options), "1.120.1");
		t.is(await Openui5Resolver.resolveVersion("^1", options.ui5DataDir, options), "1.120.1");
		t.is(await Openui5Resolver.resolveVersion("*", options.ui5DataDir, options), "1.120.1");

		// Tags
		t.is(await Openui5Resolver.resolveVersion("latest", options.ui5DataDir, options), "1.120.0");
		t.is(await Openui5Resolver.resolveVersion("next", options.ui5DataDir, options), "2.0.0-rc.1");
		t.is(await Openui5Resolver.resolveVersion("not-a-snapshot", options.ui5DataDir, options), "1.118.0");

		// Exact versions
		t.is(await Openui5Resolver.resolveVersion("1.118.0", options.ui5DataDir, options), "1.118.0");
		t.is(await Openui5Resolver.resolveVersion("2.0.0-rc.1", options.ui5DataDir, options), "2.0.0-rc.1");
		t.is(await Openui5Resolver.resolveVersion("1.123.4-SNAPSHOT", options.ui5DataDir, options), "1.123.4-SNAPSHOT");

		// SNAPSHOT ranges
		t.is(await Openui5Resolver.resolveVersion("1-SNAPSHOT", options.ui5DataDir, options), "1.123.4-SNAPSHOT");
		t.is(await Openui5Resolver.resolveVersion("1.123-SNAPSHOT", options.ui5DataDir, options), "1.123.4-SNAPSHOT");

		// Error cases
		await t.throwsAsync(Openui5Resolver.resolveVersion("", options.ui5DataDir, options), {
			message: `Framework version specifier "" is incorrect or not supported`
		});
		await t.throwsAsync(Openui5Resolver.resolveVersion("tag-does-not-exist", options.ui5DataDir, options), {
		...
		await t.throwsAsync(Openui5Resolver.resolveVersion("invalid-tag-%20", options.ui5DataDir, options), {
			message: `Framework version specifier "invalid-tag-%20" is incorrect or not supported`
		});

		await t.throwsAsync(Openui5Resolver.resolveVersion("1.999.9", options.ui5DataDir, options), {
		...
		await t.throwsAsync(Openui5Resolver.resolveVersion("1.0.0", options.ui5DataDir, options), {
		...
		await t.throwsAsync(Openui5Resolver.resolveVersion("^999", options.ui5DataDir, options), {
